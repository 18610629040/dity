...
//        width:1030,
        ...
        rowNum: 20,
        rowList: [10, 20, 30],
        colNames: ['ID','订单号', '产品名称', '是否秒杀商品订单','订单价格', '订单小计', '订单费率', '计算收益', '快递单号', '卖家','买家', '订单状态', '操作人', '操作时间'],
        colModel: [
            ...
            {name: 'ORDER_PD_TYPE_NAME',index: 'ORDER_PD_TYPE_NAME', align :"center",editable: true,width: '30%'},
            ...
            {name: 'ORDER_USER_SEL_NO',index: 'ORDER_USER_SEL_NO', align :"center",editable: true,width: '30%'},
            {name: 'ORDER_USER_BUY_NO',index: 'ORDER_USER_BUY_NO', align :"center",editable: true,width: '30%'},
